...
#     generated_insight = llm.generate(sign, base_rule)

#     # Translate if needed
#     if data.language.lower() == "hi":
#         final_text = Translator().translate(generated_insight)
#     else:
#         final_text = generated_insight

#     set_cache(cache_key, final_text)

#     return InsightOutput(zodiac=sign, insight=final_text, language=data.language)
